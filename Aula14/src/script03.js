...
function somaItems(total, item) {
    return total + item;
}

let resultadoSoma = numeros5.reduce(somaItems);
...
const frutas = ["Uva", "Morango", "Abacaxi"];
